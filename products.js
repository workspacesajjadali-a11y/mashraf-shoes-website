...
var products = [
...

  {
    id: 8,
    brand: "M Ashraf Shoes",
    name: "Men's Horsebit Buckle Loafers",
    category: "men",
    price: 2499,
    oldPrice: 3300,
    rating: 4.5,
    ...
    seoKeywords: [
      ...
      "mens horsebit buckle loafers Pakistan",
      "men's buckled loafers Pakistan",
      "mens buckled loafers Pakistan",
      ...
      "slip on shoes for men Pakistan"
    ],
    ...
    variants: [
...

      {
        color: "Black",
        images: [
          "images/mens-horsebit-buckle-loafers-black-pakistan-1.jpeg",
          "images/mens-horsebit-buckle-loafers-black-pakistan-2.jpeg"
        ],
        sizes: [41, 42, 43, 44]
      },
...

      {
        color: "Brown",
        images: [
          "images/mens-horsebit-buckle-loafers-brown-pakistan-1.jpeg",
          "images/mens-horsebit-buckle-loafers-brown-pakistan-2.jpeg"
        ],
        sizes: [41, 42, 43, 44]
      }
...

  {
    ...
    variants: [

      {
        color: "Black",
        images: [
          "images/mens-comfort-strap-sandals-black-pakistan-1.jpg",
          "images/mens-comfort-strap-sandals-black-pakistan-2.jpg"
        ],
        sizes: [7, 8, 11]
      },

      {
        color: "Tan",
        images: [
          "images/mens-comfort-strap-sandals-tan-pakistan-1.jpg",
          "images/mens-comfort-strap-sandals-tan-pakistan-2.jpg"
        ],
        sizes: [6, 7, 9, 10]
      },

      {
        color: "Dark Brown",
        images: [
          "images/mens-comfort-strap-sandals-dark-brown-pakistan-1.jpg",
          "images/mens-comfort-strap-sandals-dark-brown-pakistan-2.jpg"
        ],
        sizes: [7, 8, 9, 11]
      }
